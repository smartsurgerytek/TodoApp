...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p bff84a12-6c86-4fcb-b987-458a15055eed
```

> `bff84a12-6c86-4fcb-b987-458a15055eed` is the password of the certificate, you can change it to any password you want.
